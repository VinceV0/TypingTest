...
# This version improves upon the timer to use minutes and seconds, not purely seconds.
...
start_button = tk.Button(window, font=("Verdana", 20), fg="black", bg="green", text="Start",  command=lambda:[line(blank=''), countdown(60)])
