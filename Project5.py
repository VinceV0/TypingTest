...
# Adding in the terminal the total number of words the user has attempted and scored out of.
...
def check():
    ...
    try:
        ...
        if wordsMatched != 0:
            ...
            # For testing purposes checking the output of accuracy every time the user inputs
            print(f"Accuracy: {(wordsMatched / (chunkCount - NUMWORD + len(typedSplit))  * 100):.2f}%")
