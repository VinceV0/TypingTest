...
# This version is for UI Design
# It completes the specifications for the minimum viable product
# The timer has been set to 60 seconds and a paragraph has been put in
...
# Timer label
timer1 = tk.Label(font=("Roboto", 25, "bold"), fg="black", bg="deepskyblue2", text="[01:00]")
...
typing = tk.Entry(window, font=("Verdana", 20), bg="white", width=23, state="disabled")
...
instructions.grid(row = 5, column = 0, columnspan = 3, pady = 50)
