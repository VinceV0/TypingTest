...
# This version is for error checking the accuracy
# Instead of dividing by the total number of words available, it divides by the total number of words input
