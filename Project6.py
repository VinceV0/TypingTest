...
# This update was for error checking
# If the user enters more words than there are on the screen it will not check the extra words
# The code for getting the accuracy % has been optimized as a result
